...
public class StreamSorted
{
    public static void main(String[] args) {
        ...
        //custom using compareto (decending)
        System.out.println(numbers.stream().sorted((ele1,ele2)->ele2.compareTo(ele1)).collect(Collectors.toList()));
        System.out.println(numbers.stream().sorted((ele1,ele2)->-ele1.compareTo(ele2)).collect(Collectors.toList()));

        //custom using comparator reversed
